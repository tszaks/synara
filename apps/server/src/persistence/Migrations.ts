...
import Migration0049 from "./Migrations/049_PalliumCommandCache.ts";
import Migration0050 from "./Migrations/050_AutomationMemoryContextMode.ts";
...
export const migrationEntries = [
  ...
  [49, "PalliumCommandCache", Migration0049],
  [50, "AutomationMemoryContextMode", Migration0050],
] as const;
